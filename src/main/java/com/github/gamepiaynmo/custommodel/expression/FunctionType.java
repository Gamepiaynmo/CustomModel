...
public enum FunctionType {
   ...
   ATAN2(ExpressionType.FLOAT, "atan2", args -> (float) MathHelper.atan2(evalFloat(args, 0), evalFloat(args, 1)), ExpressionType.FLOAT, ExpressionType.FLOAT),
   ...
   EXP(ExpressionType.FLOAT, "exp", args -> (float) Math.exp(evalFloat(args, 0)), ExpressionType.FLOAT),
   FRAC(ExpressionType.FLOAT, "frac", args -> (float) MathHelper.fractionalPart(evalFloat(args, 0)), ExpressionType.FLOAT),
   LOG(ExpressionType.FLOAT, "log", args -> (float) Math.log(evalFloat(args, 0)), ExpressionType.FLOAT),
   POW(ExpressionType.FLOAT, "pow", args -> (float) Math.pow(evalFloat(args, 0), evalFloat(args, 1)), ExpressionType.FLOAT, ExpressionType.FLOAT),
