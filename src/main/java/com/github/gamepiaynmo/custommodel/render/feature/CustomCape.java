...
public class CustomCape extends CapeFeatureRenderer {
    ...
    public void render(AbstractClientPlayerEntity abstractClientPlayerEntity_1, float float_1, float float_2, float float_3, float float_4, float float_5, float float_6, float float_7) {
        ...
        Supplier<Identifier> customCapeTex = pack.getTexture("cape.png");
        boolean customCape = customCapeTex != null;
        if (!abstractClientPlayerEntity_1.isInvisible() && abstractClientPlayerEntity_1.isSkinOverlayVisible(PlayerModelPart.CAPE) && ((abstractClientPlayerEntity_1.getCapeTexture() != null && abstractClientPlayerEntity_1.canRenderCapeTexture()) || customCape)) {
            ...
            if (itemStack_1.getItem() != Items.ELYTRA) {
                ...
                this.bindTexture(customCape ? customCapeTex.get() : abstractClientPlayerEntity_1.getCapeTexture());
